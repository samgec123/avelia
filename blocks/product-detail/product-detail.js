...
function swatchColor(color) {
  const map = {
    white: 'FFFFF0', black: '1A1A1A', navy: '1B2A4A', cream: 'F5ECD5',
    ivory: 'FFFFF0', camel: 'C19A6B', cognac: '9A4B1F', stone: 'D9CAAA',
    sage: '8F9E7E', rust: 'B94A25', olive: '6B6C3A', grey: '8A8A8A',
    blue: '3B6EA5', chocolate: '4A2510', burgundy: '7C1D2C', gold: 'B89A5C',
    tan: 'D2B48C', brown: '8B5E3C', silver: 'A9A9A9', tortoise: '8B5E2C',
    natural: 'F5ECD5', khaki: 'C3B091', indigo: '4B5C78',
  };
